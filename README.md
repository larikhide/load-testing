...
- расширить архитектуру системы, дописать некоторые недостающие сервисы и провести анализ производительности. В качестве дополнительного сервиса использовать СУБД для хранения прав ACL — ранее описаны права доступа прямо в коде функции `acl.Identity`.
